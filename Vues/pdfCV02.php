...
<body>
	...
	<div id="cv">
		...
		<ul>
			...
			<li><h4> <?php echo ($_SESSION['adresse']) ?> </h4></li>
			<li><h4> <?php echo ($_SESSION['appartement']) ?> </h4></li>
			<li><h4> <?php echo ($_SESSION['ville']) ?> </h4></li>
			<li><h4> <?php echo ($_SESSION['codepostal']) ?> </h4></li>
